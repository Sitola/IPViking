    ...
    */
    ...
    function start(loc, psk) {
        ...
        webSocket.onclose = function() {
            ...
            d3.select("#events-data").selectAll("tr.row").remove();
            d3.select("#events-data").append("tr").attr('class', 'row').html("<td colspan='7'><img src='http://map.ipviking.com/images/loading.gif' style='margin-top: 6px;'/>&nbsp;<span style='display: inline-block; height: 25px; vertical-align: middle;'>Loading...</span></td>");
    ...
    queue()
        .defer(d3.json, "uploads/apps/ipviking/data/readme-world.json")
        .defer(d3.tsv,  "uploads/apps/ipviking/data/port-names.tsv")
        .defer(d3.csv,  "uploads/apps/ipviking/data/country-codes.csv")
